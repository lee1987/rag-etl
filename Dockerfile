...
RUN wget https://archive.apache.org/dist/spark/spark-3.5.3/spark-3.5.3-bin-hadoop3.tgz && \
    ...
    wget https://repo1.maven.org/maven2/com/amazonaws/aws-java-sdk-bundle/1.12.1/aws-java-sdk-bundle-1.12.1.jar && \
    mv aws-java-sdk-bundle-1.12.1.jar /spark/jars && \
...
# Set encoding used for stdin/stdout/stderr.
